...
public class DateTimeConstants {
    ...
    public static final LocalDate FIRST_DAY_OF_THE_MONTH = LocalDate.now().withDayOfMonth(1);
    public static final LocalDate FIRST_DAY_OF_LAST_MONTH = LocalDate.now().minusMonths(1).withDayOfMonth(1);
